      ...
      <div className="border border-card-border rounded-xl overflow-hidden bg-card/30">
        <table className="w-full text-left text-xs">
          ...
          <tbody className="divide-y divide-card-border">
            {loading ? (
              <tr>
                <td colSpan={6} className="px-5 py-8 text-center text-muted-foreground font-mono">
              ...
              filteredEmployees.map((emp) => (
                <tr key={emp.id} className="hover:bg-card/60 transition-colors">
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-muted border border-card-border flex items-center justify-center font-semibold text-foreground text-xs">
                    ...
                    <div className="flex flex-wrap gap-1 max-w-xs">
                      {emp.positions.length > 0 ? (
                        emp.positions.map((pos) => (
                          <span
                            key={pos.id}
                            className="bg-muted text-muted-foreground px-2 py-0.5 rounded text-[10px] flex items-center gap-1"
                          >
                        ...
                        <span className="text-muted-foreground text-[11px] italic">No positions</span>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-5 py-3.5 text-right">
                    <div className="inline-flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="p-1.5 text-muted-foreground hover:text-rose-400 hover:bg-muted rounded-md transition-colors disabled:opacity-30"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-background border border-card-border rounded-lg text-xs text-foreground focus:outline-none focus:border-emerald-500 cursor-pointer"
                  >
              ...
              <div>
                ...
                {positions.length === 0 ? (
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-36 overflow-y-auto p-2 bg-background border border-card-border rounded-lg">
                    {positions.map((pos) => {
