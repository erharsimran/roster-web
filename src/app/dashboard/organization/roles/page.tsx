    ...
    <div className="space-y-6 max-w-6xl">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-xl border transition-all flex items-center justify-between ${
                      isSelected
                        ...
                        : 'bg-neutral-900/30 border-neutral-800/80 text-neutral-400 hover:text-neutral-200 hover:bg-neutral-900/60'
                    }`}
                  >
                    ...
                    {role.isSystemRole && (
                      <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-neutral-800 text-neutral-400 border border-neutral-700 uppercase">
                        System[cite: 1]
                      </span>
                    )}
                  </button>
          ...
          <div className="md:col-span-2 border border-neutral-800 rounded-xl bg-neutral-900/30 p-5 space-y-5">
              ...
              <div className="flex items-center gap-2">
                {activeRole?.name.toLowerCase() !== 'owner' && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-neutral-700 bg-neutral-800 text-neutral-200 hover:text-white hover:bg-neutral-700 text-xs font-medium transition-colors"
                  >
              ...
              {activeRole?.name.toLowerCase() === 'owner' ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {activeRole?.permissions?.map((perm) => (
                    <div
                      key={perm.id}
                      className="p-2.5 rounded-lg bg-neutral-900 border border-neutral-800 flex items-center gap-2.5 text-xs text-neutral-300"
                    >
      ...
      {modalMode && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl max-w-2xl w-full p-6 shadow-2xl space-y-4 max-h-[90vh] flex flex-col">
                ...
                <div className="space-y-4">
                  {groupedPermissions.map(([groupName, groupPerms]) => {
                    ...
                    return (
                      <div
                        key={groupName}
                        className="border border-neutral-800/80 rounded-xl p-3.5 bg-neutral-950/40 space-y-2.5"
                      >
                        <div className="flex items-center justify-between border-b border-neutral-800/60 pb-2">
                          <span className="font-mono text-[11px] font-semibold text-neutral-300 uppercase">
                            {groupName} module
                          </span>
                          <button
                            type="button"
